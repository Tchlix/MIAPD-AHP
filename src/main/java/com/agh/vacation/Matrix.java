...
enum Matrix {
    ...
    VALUE_FOR_MONEY(new Array2DRowRealMatrix(new double[][]{
    ...
    NIGHT_LIFE(new Array2DRowRealMatrix(new double[][]{
                //Venice    Rome      Lisbon     Madrid      Warsaw
    ...
    SIGHTS(new Array2DRowRealMatrix(new double[][]{
                    //Venice    Rome      Lisbon    Madrid      Warsaw
    ...
    MUSEUMS(new Array2DRowRealMatrix(new double[][]{
                    //Venice    Rome      Lisbon     Madrid      Warsaw
    ...
    FOOD(new Array2DRowRealMatrix(new double[][]{
                    //Venice    Rome      Lisbon    Madrid       Warsaw
